...
/**
 * JUnit TestCase for the class org.lfjr.jts.ClientListener
 *
 * @author Emmanuel Bourg
 * @version $Revision$, $Date$
 */
public class ClientListenerTest extends TestCase
{
    private ClientListener listener;

    public ClientListenerTest(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(ClientListenerTest.class);
    }
