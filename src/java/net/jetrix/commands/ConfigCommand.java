...
public class ConfigCommand extends AbstractCommand
{
    ...
    public void execute(CommandMessage m)
    {
        ...
        configLines[1] = "<darkBlue>" + Language.getText("command.config.blocks.leftl", locale) + "	: <purple>" + s.getOccurancy(LEFTL) + "%</purple>		(<purple>A</purple>) " + Language.getText("command.config.specials.addline", locale) + "	: " + "<purple>" + s.getOccurancy(ADDLINE) + "%";
        configLines[2] = "<darkBlue>" + Language.getText("command.config.blocks.rightl", locale) + "	: <purple>" + s.getOccurancy(RIGHTL) + "%</purple>		(<purple>C</purple>) " + Language.getText("command.config.specials.clearline", locale) + "	: " + "<purple>" + s.getOccurancy(CLEARLINE) + "%";
