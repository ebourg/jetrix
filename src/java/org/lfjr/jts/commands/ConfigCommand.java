...
public class ConfigCommand implements Command
{
    ...
    public void execute(Message m)
    {
        ...
        configLines[5]  = ChatColors.darkBlue + "Right Z	: "+ChatColors.purple+s.getBlockOccurancy(Settings.BLOCK_RIGHTZ)+"%"+ChatColors.purple+"		("+ChatColors.purple+"S"+ChatColors.purple+") Switch Field	: "+ChatColors.purple+s.getSpecialOccurancy(Settings.SPECIAL_SWITCHFIELD)+"%";
